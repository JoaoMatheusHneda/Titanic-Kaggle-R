...
calcula_tab_frequencia <- function(tabela_de_entrada,nome_variavel){
...
grafico_tab_frequencia <- function(table_count_prop,nome_variavel,cor_grafico,nudge_x_e,nudge_x_d,size){
...
## Only Percentage
grafico_tab_frequencia2 <- function(table_count_prop,nome_variavel,cor_grafico,size,angle){
    gg_count_prop <-  ggplot2::ggplot(aes(x=Category,y=Frequency),data=table_count_prop) +  ggplot2::theme_classic() + 
                                                         ggplot2::geom_col(fill=cor_grafico) +
                                                         ggplot2::geom_text(aes(label=paste0(Percentage,'%')),
                                                                    position = position_dodge(0.9),
